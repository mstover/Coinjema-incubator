public class BattleSim {
	...
	public static void main(String[] args) {
		Team[] teams = new Team[] {
				new Team(new Player(WeaponType.SWORD_AND_SMALL_SHIELD, 5, 10,
						4, 4), new Player(WeaponType.SWORD_AND_SMALL_SHIELD, 5,
						10, 4, 4), new Player(
						WeaponType.SWORD_AND_SMALL_SHIELD, 5, 10, 4, 4),
						new Player(WeaponType.TWO_HANDED, 5, 10, 4, 4)),
				new Team(new Player(WeaponType.SWORD_AND_MED_SHIELD, 5, 10, 4,
						4), new Player(WeaponType.SWORD_AND_MED_SHIELD, 5, 10,
						4, 4), new Player(WeaponType.TWO_HANDED, 5, 10, 4, 4),
						new Player(WeaponType.TWO_HANDED, 5, 10, 4, 4)) };
